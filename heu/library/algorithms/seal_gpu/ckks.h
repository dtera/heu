...
//                         || std::is_same<std::remove_cv_t<T_out>,
...
class Arithmetic<std::complex<double>, std::complex<double>, double> {
 public:
  ...
  inline std::complex<double> add(const std::complex<double> &a,
                                  const std::complex<double> &b) const {
    return a + b;
  }

  inline std::complex<double> sub(const std::complex<double> &a,
                                  const std::complex<double> &b) const {
    return a - b;
  }

  inline std::complex<double> mulRoot(const std::complex<double> &a,
                                      const std::complex<double> &r) const {
    return a * r;
  }

  inline std::complex<double> mulScalar(const std::complex<double> &a,
                                        const double &s) const {
    return a * s;
  }

  inline std::complex<double> mulRootScalar(const std::complex<double> &r,
                                            const double &s) const {
    return r * s;
  }
...
class CKKSEncoder {
  ...
  using FFTHandler =
      util::DWTHandler<std::complex<double>, std::complex<double>, double>;
 ...
 private:
  ...
  void decodeInternal(const Plaintext &plain,
