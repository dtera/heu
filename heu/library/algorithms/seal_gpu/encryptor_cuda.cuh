...
It is important for a developer to understand how this works to avoid
unnecessary performance bottlenecks.

@par NTT form
When using the BFV/BGV scheme (scheme_type::bfv/bgv), all plaintext and
ciphertexts should remain by default in the usual coefficient representation,
i.e. not in NTT form. When using the CKKS scheme (scheme_type::ckks), all
plaintexts and ciphertexts should remain by default in NTT form. We call these
scheme-specific NTT states the "default NTT form". Decryption requires the input
ciphertexts to be in the default NTT form, and will throw an exception if this
is not the case.
*/
class EncryptorCuda {
 public:
  ...
  */
  EncryptorCuda(const SEALContextCuda &context,
  ...
  */
  inline void encrypt(const PlaintextCuda &plain,
  ...
  @throws std::invalid_argument if pool is uninitialized
  */
  inline CiphertextCuda encrypt(const PlaintextCuda &plain) const {
  ...
  */
  ...
  @throws std::invalid_argument if pool is uninitialized
  */
  inline CiphertextCuda encryptZero(ParmsID parms_id) const {
    CiphertextCuda destination;
  ...
  @throws std::invalid_argument if pool is uninitialized
  */
  inline void encryptZero(ParmsID parms_id, CiphertextCuda &destination) const {
    encryptZeroInternal(parms_id, true, destination);
  }
  ...
  */
  ...
  @throws std::invalid_argument if pool is uninitialized
  */
  inline void encryptSymmetric(const PlaintextCuda &plain,
                               CiphertextCuda &destination) const {
  ...
  */
  ...
  @throws std::invalid_argument if pool is uninitialized
  */
  inline void encryptZeroSymmetric(ParmsID parms_id,
                                   CiphertextCuda &destination) const {
  ...
  @throws std::invalid_argument if pool is uninitialized
  */
  inline CiphertextCuda encryptZeroSymmetric(ParmsID parms_id) const {
    CiphertextCuda destination;
    encryptZeroInternal(parms_id, false, destination);
    return destination;
  }
  ...
  @throws std::invalid_argument if pool is uninitialized
  */
  inline void encryptZeroSymmetric(CiphertextCuda &destination) const {
 ...
 private:
  ...
  void encryptZeroInternal(ParmsID parms_id, bool is_asymmetric,
                           CiphertextCuda &destination) const;

  void encryptInternal(const PlaintextCuda &plain, bool is_asymmetric,
                       CiphertextCuda &destination) const;
