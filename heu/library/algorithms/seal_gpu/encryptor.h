...
class Encryptor {
  ...
  */
  inline void encrypt(const Plaintext &plain, Ciphertext &destination) const {
  ...
  @throws std::invalid_argument if pool is uninitialized
  */
  inline Ciphertext encrypt(const Plaintext &plain) const {
  ...
  */
  ...
  @throws std::invalid_argument if pool is uninitialized
  */
  inline Ciphertext encryptZero(ParmsID parms_id) const {
    Ciphertext destination;
  ...
  @throws std::invalid_argument if pool is uninitialized
  */
  inline void encryptZero(ParmsID parms_id, Ciphertext &destination) const {
    encryptZeroInternal(parms_id, true, destination);
  }
  ...
  */
  ...
  @throws std::invalid_argument if pool is uninitialized
  */
  inline void encryptSymmetric(const Plaintext &plain,
  ...
  */
  ...
  @throws std::invalid_argument if pool is uninitialized
  */
  inline Ciphertext encryptZeroSymmetric(ParmsID parms_id) const {
    Ciphertext destination;
    encryptZeroInternal(parms_id, false, destination);
    return destination;
  }
  ...
  @throws std::invalid_argument if pool is uninitialized
  */
  inline void encryptZeroSymmetric(Ciphertext &destination) const {
 ...
 private:
  ...
  void encryptInternal(const Plaintext &plain, bool is_asymmetric,
                       Ciphertext &destination) const;
