...
class ConstHostPointer {
 ...
 public:
  ...
  ConstHostPointer &operator++() {
    ptr++;
    return *this;
  }

  ConstHostPointer operator++(int) {
    ConstHostPointer copied = *this;
    ptr++;
    return copied;
  }
};
...
class HostPointer {
 ...
 public:
  ...
  HostPointer<T> operator+(size_t d) const { return HostPointer<T>(ptr + d); }
  ...
  HostPointer &operator++() {
    ptr++;
    return *this;
  }

  HostPointer operator++(int) {
    HostPointer copied = *this;
    ptr++;
    return copied;
  }
...
class HostArray {
 ...
 public:
  ...
  HostArray(T *data, std::size_t cnt) : data(data), len(cnt) {}
...
class HostDynamicArray {
 ...
 public:
  ...
  HostDynamicArray(size_t capacity, size_t size)
