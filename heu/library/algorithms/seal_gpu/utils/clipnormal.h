...
class ClippedNormalDistribution {
 public:
  ...
  inline result_type mean() const noexcept { return normal_.mean(); }

  inline result_type standardDeviation() const noexcept {
    return normal_.stddev();
  }

  inline result_type maxDeviation() const noexcept { return max_deviation_; }
  ...
  inline param_type param() const noexcept { return *this; }
