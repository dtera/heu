...
void addPolyScalarCoeffmod(ConstHostPointer<uint64_t> poly, size_t coeff_count,
                           uint64_t scalar, const Modulus &modulus,
                           HostPointer<uint64_t> result) {
  for (std::size_t i = 0; i < coeff_count; i++) {
...
void subPolyScalarCoeffmod(ConstHostPointer<uint64_t> poly, size_t coeff_count,
                           uint64_t scalar, const Modulus &modulus,
                           HostPointer<uint64_t> result) {
  for (std::size_t i = 0; i < coeff_count; i++) {
    const uint64_t x = poly[i];
...
uint64_t polyInftyNormCoeffmod(HostPointer<uint64_t> operand,
                               size_t coeff_count, const Modulus &modulus) {
