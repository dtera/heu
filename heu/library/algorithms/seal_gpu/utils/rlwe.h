...
*/
void samplePolyTernary(std::shared_ptr<UniformRandomGenerator> prng,
                       const EncryptionParameters &parms,
                       std::uint64_t *destination);

/**
Generate a polynomial from a normal distribution and store in RNS
representation.
...
@param[out] destination Allocated space to store a random polynomial
*/
void samplePolyNormal(std::shared_ptr<UniformRandomGenerator> prng,
                      const EncryptionParameters &parms,
                      std::uint64_t *destination);

/**
Generate a polynomial from a centered binomial distribution and store in RNS
representation.
...
@param[out] destination Allocated space to store a random polynomial
*/
void samplePolyCbd(std::shared_ptr<UniformRandomGenerator> prng,
                   const EncryptionParameters &parms,
                   std::uint64_t *destination);
...
@param[out] destination Allocated space to store a random polynomial
*/
void samplePolyUniform(std::shared_ptr<UniformRandomGenerator> prng,
                       const EncryptionParameters &parms,
                       std::uint64_t *destination);
...
//     std::shared_ptr<UniformRandomGenerator> prng, const EncryptionParameters
//     &parms, std::uint64_t *destination);
