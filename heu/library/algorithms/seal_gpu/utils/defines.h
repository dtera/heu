...
#define SEAL_MULTIPLY_ACCUMULATE_MOD_MAX \
  (1 << (128 - (SEAL_MOD_BIT_COUNT_MAX << 1)))
#define SEAL_MULTIPLY_ACCUMULATE_INTERNAL_MOD_MAX \
  (1 << (128 - (SEAL_INTERNAL_MOD_BIT_COUNT_MAX << 1)))
#define SEAL_MULTIPLY_ACCUMULATE_USER_MOD_MAX \
  (1 << (128 - (SEAL_USER_MOD_BIT_COUNT_MAX << 1)))
#else
