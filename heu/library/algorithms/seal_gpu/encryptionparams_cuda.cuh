...
class EncryptionParametersCuda {
  friend struct std::hash<seal_gpu::EncryptionParametersCuda>;

 public:
  EncryptionParametersCuda(SchemeType scheme = SchemeType::none)
      : scheme_(scheme), cpu(scheme) {
    computeParmsID();
  }
  ...
  // }
  EncryptionParametersCuda &operator=(const EncryptionParametersCuda &assign) =
      default;

  EncryptionParametersCuda(EncryptionParametersCuda &&source) = default;
  EncryptionParametersCuda &operator=(EncryptionParametersCuda &&assign) =
      default;
...
template <>
struct hash<seal_gpu::EncryptionParametersCuda> {
  std::size_t operator()(
      const seal_gpu::EncryptionParametersCuda &parms) const {
